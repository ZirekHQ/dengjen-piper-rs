...
That split was reverted: a single shared version is simpler to reason about
-- "these N crates at version X work together" holds for the whole workspace
...
See https://github.com/ZirekHQ/dengjen-piper-rs/issues/115[#115].

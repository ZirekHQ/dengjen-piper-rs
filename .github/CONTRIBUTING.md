...
and keeps `git log` skimmable. Example: `fix: reconstruct clause punctuation from espeak-ng
terminator`. See [conventionalcommits.org](https://www.conventionalcommits.org/) for the full
spec.
...
See [README.md](../README.md) for install/usage and [BUILDING.md](../BUILDING.md) for build
gotchas and the crates.io release process.
